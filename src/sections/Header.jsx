...
const Header = () => {
    ...
    return (
        ...
        >
            <h1
            className='text-black md-text-4xl text-3xl font-bold font-rubik'
            >Prime<span className='text-yellow-500 italic'>Structures</span></h1>

            <ul className='lg:flex justify-center items-center gap-6 hidden'>
                {navItems.map(({link, path}) => (
                    <Link key={path} className='text-black uppercase font-bold cursor-pointer p-3 rounded-full hover:bg-yellow-500 hover:text-black font-rubik text-[15px]'
            ...
            {/* MOBİLE MENU START HERE*/}
            <div className='flex justify-between items-center lg:hidden mt-3' onClick=
            {toggleMenu}>
                <div>
